...
<div id="zixun-home">
	...
	<div id="zixun-scroll" v-scroll="zixunScroll"><div>
		...
		<div v-if="pullIsShow" class="pull pullDownEl">
		...
		<div v-if="pullIsShow" class="pull pullUpEl"> <span>上拉加载更多</span></div>
	</div></div>
</div>
</template>
...
export default {
    ...
    data() {
      return {
      	pullDown: '下拉刷新',
      	pullUp: '加载更多',
      	pullPngSrc: 'http://127.0.0.1/images/teemo_8.png',
      	headerNav:false,		
      	topbgcolor: 0,
      	topimgurl:'',
      	curlist: 0,
      	zixunScroll: { el:'#zixun-scroll', scroll:null},
        banner: [],
        list: [],
